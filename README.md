...
| 复习 / 知识地图 / Git | 将记录沉淀为可复用、可导出的知识资产 | 规划中 |
...
- [ ] 完成学习会话后沉淀 Draft、Note、Relation 与 Review Card。
- [ ] 使用 SQLite 支持离线写入、待同步队列与联网恢复。
- [ ] 完成桌面端与移动端的增量同步、删除同步和冲突副本处理。
- [ ] 补齐图片记录、上传恢复与资源清理流程。
- [ ] 完善问题状态同步、重新打开问题和跨端筛选。
- [ ] 增加复习计划、统计、全文搜索与知识地图。
- [ ] 增加 Git 导出、版本记录和恢复能力。
